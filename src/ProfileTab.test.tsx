...
describe("ProfileTab", () => {
  ...
  describe("Google Calendar Integration", () => {
    it("shows Google Calendar section", async () => {
      ...
      expect(screen.getByText((content) => content.includes("Google Calendar"))).toBeInTheDocument();
    });
  ...
  describe("Workspace Backup Section", () => {
    it("shows workspace backup section", async () => {
      ...
      expect(screen.getAllByText((content) => content.includes("Eksport")).length).toBeGreaterThan(0);
    });
  ...
  describe("Edge Cases", () => {
    ...
    it("handles very long bio text", () => {
      ...
      render(
        <ProfileTab
          {...baseProps}
          profileDraft={{ ...baseProps.profileDraft, bio: longBio }}
        />
      );
  ...
  describe("User Info Display", () => {
    ...
    it("shows Google account type for Google provider", () => {
      render(
        <ProfileTab
          {...baseProps}
          currentUser={{ ...baseProps.currentUser, provider: "google" }}
        />
      );
