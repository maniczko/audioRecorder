    ...
    <header className="topbar">
      <div className="topbar-title">
        ...
        <div className="tab-switcher">
          ...
          <button type="button" className={ui.activeTab === "studio" ? "tab-pill active" : "tab-pill"} onClick={() => ui.setActiveTab("studio")}>
          ...
          <button type="button" className={ui.activeTab === "recordings" ? "tab-pill active" : "tab-pill"} onClick={() => ui.setActiveTab("recordings")}>
          ...
          <button type="button" className={ui.activeTab === "calendar" ? "tab-pill active" : "tab-pill"} onClick={() => ui.setActiveTab("calendar")}>
          ...
          <button type="button" className={ui.activeTab === "tasks" ? "tab-pill active" : "tab-pill"} onClick={() => ui.setActiveTab("tasks")}>
          ...
          <button type="button" className={ui.activeTab === "people" ? "tab-pill active" : "tab-pill"} onClick={() => ui.setActiveTab("people")}>
          ...
          <button type="button" className={ui.activeTab === "notes" ? "tab-pill active" : "tab-pill"} onClick={() => ui.setActiveTab("notes")}>
