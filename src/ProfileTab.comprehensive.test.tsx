...
describe("ProfileTab", () => {
  ...
  describe("Account Category - Profile Section", () => {
    ...
    it("displays avatar or fallback based on avatarUrl", () => {
      ...
      // With avatar URL
      rerender(<ProfileTab {...mockProps} profileDraft={{ ...mockProps.profileDraft, avatarUrl: "https://example.com/avatar.jpg" }} />);
  ...
  describe("Password Section", () => {
    ...
    it("shows info message for Google accounts without password", () => {
      render(<ProfileTab {...mockProps} currentUser={{ ...mockProps.currentUser, provider: "google", passwordHash: undefined }} />);
  ...
  describe.skip("Audio Storage Section", () => {
    ...
    it("shows warning message when provided", async () => {
      const user = userEvent.setup();
      render(<ProfileTab {...mockProps} audioStorageState={{ ...mockProps.audioStorageState, warningMessage: "Storage almost full" }} />);
