    ...
    <header className="topbar ui-topbar">
      <div className="topbar-title">
        ...
        <Cluster className="tab-switcher" gap="sm">
          ...
          <button
            type="button"
            className={ui.activeTab === 'studio' ? 'tab-pill active' : 'tab-pill'}
          ...
          <button
            type="button"
            className={ui.activeTab === 'recordings' ? 'tab-pill active' : 'tab-pill'}
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path d="M22 19V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2z" />
          ...
          <button
            type="button"
            className={ui.activeTab === 'calendar' ? 'tab-pill active' : 'tab-pill'}
          ...
          <button
            type="button"
            className={ui.activeTab === 'tasks' ? 'tab-pill active' : 'tab-pill'}
          ...
          <button
            type="button"
            className={ui.activeTab === 'people' ? 'tab-pill active' : 'tab-pill'}
          ...
          <button
            type="button"
            className={ui.activeTab === 'notes' ? 'tab-pill active' : 'tab-pill'}
        ...
        {workspace.availableWorkspaces.length > 1 ? (
          <label className="workspace-switch">
            ...
            <select
              ...
              onChange={(event) => ui.switchWorkspace(event.target.value)}
            >
        ...
        <div className="user-card">
          {workspace.currentUser.avatarUrl ? (
            <img
              ...
              alt={workspace.currentUser.name}
              className="avatar"
            />
          ) : null}
          <div>
            <strong>{workspace.currentUser.name}</strong>
            {(workspace.currentUser.role && workspace.currentUser.role !== 'No role') ||
            workspace.currentUser.provider === 'google' ? (
              <span>
