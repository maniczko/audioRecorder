...
describe('buildPeopleProfiles', () => {
  ...
  test('should unique names and build profiles', () => {
    const result = buildPeopleProfiles(
      mockMeetings,
      mockTasks,
      mockCurrentUser,
  ...
  test('should create summary string using Polish marks and reverse chronological order', () => {
    ...
    const expected =
      'Jan Kowalski pilnuje planu i terminów. Najczęściej oczekuje: Budżet. Po spotkaniach najbardziej liczą się dla tej osoby: Zatwierdzenie.';
