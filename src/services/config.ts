...
export const APP_DATA_PROVIDER = readMode(
  process.env.REACT_APP_DATA_PROVIDER || "remote",
  "local"
);

export const MEDIA_PIPELINE_PROVIDER = readMode(
  process.env.REACT_APP_MEDIA_PROVIDER || "remote",
  "local"
);

export const API_BASE_URL = String(process.env.REACT_APP_API_BASE_URL || "http://localhost:4000").trim();
