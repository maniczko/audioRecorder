...
export default function useMeetingLifecycle({
  ...
  useEffect(() => {
    ...
    // Add logic to handle the meeting draft restoration here
  }, [currentUserId, currentWorkspaceId, selectedMeeting, selectedRecording]); // Include selectedMeeting and selectedRecording as dependencies

  // Additional logic for handling meeting drafts can be added here
