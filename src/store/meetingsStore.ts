...
interface MeetingsState {
  ...
  setTaskState: (updater: Record<string, any> | ((prev: Record<string, any>) => Record<string, any>)) => void;
  setTaskBoards: (updater: Record<string, any> | ((prev: Record<string, any>) => Record<string, any>)) => void;
  setCalendarMeta: (updater: Record<string, any> | ((prev: Record<string, any>) => Record<string, any>)) => void;
  setVocabulary: (updater: any[] | ((prev: any[]) => any[])) => void;
  setWorkspaceMessage: (msg: string) => void;
  
  setStoredMeetingDrafts: (updater: Record<string, any> | ((prev: Record<string, any>) => Record<string, any>)) => void;
...
export const useMeetingsStore = create<MeetingsState>()(
  persist(
    (set, get) => ({
      ...
      setMeetings: (updater) => set((state) => ({ meetings: typeof updater === "function" ? updater(state.meetings) : updater })),
      setManualTasks: (updater) => set((state) => ({ manualTasks: typeof updater === "function" ? updater(state.manualTasks) : updater })),
      setTaskState: (updater) => set((state) => ({ taskState: typeof updater === "function" ? updater(state.taskState) : updater })),
      setTaskBoards: (updater) => set((state) => ({ taskBoards: typeof updater === "function" ? updater(state.taskBoards) : updater })),
      setCalendarMeta: (updater) => set((state) => ({ calendarMeta: typeof updater === "function" ? updater(state.calendarMeta) : updater })),
      setVocabulary: (updater) => set((state) => ({ vocabulary: typeof updater === "function" ? updater(state.vocabulary) : updater })),
      setWorkspaceMessage: (msg: string) => set({ workspaceMessage: msg }),
      
      setStoredMeetingDrafts: (updater) => set((state) => ({ storedMeetingDrafts: typeof updater === "function" ? updater(state.storedMeetingDrafts) : updater })),
      setMeetingDraft: (updater) => set((state) => {
