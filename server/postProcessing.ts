...
export async function analyzeMeetingWithOpenAI({ meeting, segments, speakerNames }: any) {
  ...
  const prompt = [
    ...
    '',
    'ZADANIE FEEDBACK (KRYTYCZNE — sekcja "feedback" w JSON):',
    'Pisz jak szczery coach, NIE jak uprzejmy asystent. Zasady:',
    '1. ZERO SŁODZENIA — nie zaczynaj od komplementu, żeby złagodzić krytykę. Jeśli coś było słabe, napisz to wprost.',
    '2. KONKRETNOŚĆ — zamiast "można poprawić komunikację" napisz dokładnie CO było nie tak i KIEDY w rozmowie to wystąpiło (podaj timestamp lub cytat).',
    '3. PORÓWNANIA — porównuj do standardu profesjonalnych spotkań: czy był cel, agenda, decyzje, właściciele, terminy? Jeśli nie — nazwij to brakiem.',
    '4. WZORCE ZACHOWAŃ — jeśli ktoś dominuje, przerywa, nie słucha, unika decyzji — napisz to wprost ze wskazaniem kto i kiedy.',
    '5. OCENA REALNA — score 5/10 oznacza przeciętne spotkanie. 7/10 to solidne. 9-10 to wyjątkowe. NIE dawaj 8/10 domyślnie.',
    '6. categoryScores: każda obserwacja (observation) MUSI zawierać konkretny dowód z transkryptu. Każdy improvementTip MUSI być jednozdaniową instrukcją do wdrożenia na następnym spotkaniu.',
    '7. whatWentWell: max 3 rzeczy, TYLKO jeśli naprawdę poszły dobrze. Puste jeśli nic nie wyróżniało się pozytywnie.',
    '8. whatCouldBeBetter: max 3 najważniejsze problemy z konkretnymi przykładami z rozmowy.',
